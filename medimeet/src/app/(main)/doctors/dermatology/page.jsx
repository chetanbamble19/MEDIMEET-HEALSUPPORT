...
export default function DermatologistBooking() {
      ...
      <div className="w-1/3 bg-[#1e1e1e] p-8 flex flex-col items-center text-center space-y-4">
        <div className="rounded-full overflow-hidden w-32 h-32 border-4 border-emerald-500">
          <Image
            ...
            alt="Dr. Piyush Agarwal"
            width={128}
            height={128}
            className="object-cover"
          />
        </div>
        <h2 className="text-2xl font-bold">Dr. Piyush Agarwal</h2>
        ...
        <p className="text-gray-400 text-sm flex items-center gap-1 justify-center">
          ...
          >
            <path
              ...
              strokeWidth={2}
              d="M12 8c1.657 0 3-1.567 3-3.5S13.657 1 12 1 9 2.567 9 4.5 10.343 8 12 8zM12 14c-4.418 0-8 2.239-8 5v3h16v-3c0-2.761-3.582-5-8-5z"
            />
          </svg>
          3 years experience
        </p>
  ...
  className="mt-4 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg font-semibold transition"
>
  Start Video Call
</button>
