...
const AdminDashboard = () => {
  ...
  return (
    <div style={{ padding: '2rem', background: '#111', color: '#fff', fontFamily: 'sans-serif', minHeight: '100vh' }}>
      <button onClick={() => router.push('/')} style={{ color: '#0ff', marginBottom: '1rem', border: 'none', background: 'none', cursor: 'pointer' }}>
        ← Back to Home
      </button>
      ...
      <div style={{ marginTop: '2rem' }}>
        ...
        {doctors.map((doctor) => (
          <div key={doctor.id} style={{
            ...
            <div>
              <span style={{ background: 'orange', padding: '4px 8px', borderRadius: '4px', marginRight: '1rem' }}>
                {doctor.status}
              </span>
              <button
